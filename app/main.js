...
angular
    ...
    .run(['$rootScope', '$state', 'account', 'share', function($rootScope, $state, account, share) {
        $rootScope.$on('$stateChangeStart', function (event, toState, toParams) {
            ...
            // if(share.CRM_GLOBAL["hasGetPower"]){
            //     let aUserPower = share.CRM_GLOBAL['user_power'] || {};
            //     let aPowerMenu = aUserPower.menu_tree || {};
            ...
            //         /*
            //          * 原来的登陆路由是account.login
            //          * 现在的换成了login.index，但是有些用户还是会通过这个路径登录
            //          * 直接强跳到 login.index
            //          */
            //         $state.go('login.index');
            //     }else {
            //         account.getUserPower().then(function(rs) {   //todo重复请求问题
            //             share.CRM_GLOBAL["hasGetPower"] = true;
            //             // console.info('rs ', rs,toState, toParams)
            //             if (rs && rs.data.is_succ) {

            //                 //已登录情况，则恢复当前路由
            //                 share.CRM_GLOBAL['user_power'] = rs.data.data;
            ...
            //      var aMenus = share.CRM_GLOBAL.user_power.menus || {};
            //      var hasPower = false;
            ...
            //     var oResult = null;
            //     var aMenuTree = share.CRM_GLOBAL.user_power.menu_tree || {};
